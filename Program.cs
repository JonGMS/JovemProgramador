...
class HelloWorld
{
  static void Main()
  {
    ...
    while (true)
    {
      ...
      {
        Console.Clear();
        string operador = ApresentarMenu();
        ...
        while (condicao < 1)
        {
          ...
          Console.ResetColor();
          Console.Write("Para continuar aparte [ENTER]");
          Console.ReadLine();
          Console.Clear();
          contador++;
        }
      ...
      else if (opcao == 2)//Simulador de cadastro
      {
        ...
        while (argumento)
        {
          ...
          Console.Write("Digite "); ApresentarComDestaque("[1] para CADASTRAR ALUNO\n", ConsoleColor.Cyan);
          string opcaoAluno = Console.ReadLine();
          if (opcaoAluno == "1")
          {
      ...
      else if (opcao == 3)
      {
        ...
        if (strOpcao == "1")
        {
          ...
          for (int i = 0; i < idAluno.Length; i++)
          {
            ...
            {
              int nota = notasRandon.Next(4, 10);
              provas[j] = nota;
            }
  ...
  public static void ApresentarTitulo()//Calculadora
  {
    Console.Clear();
  ...
  public static string ApresentarMenu()//Calculadora
  {
